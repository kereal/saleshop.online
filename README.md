...
Сделать
  ...
  * генерация title в каталоге
  * установка метрики
  * поиск по каталогу
  * переезд на postgresql
  * покупка и переезд на продакшн сервер
  * склейка товаров по title (и еще чему-нить)
  * сделать доску в trello и притащить туда Виталика
